...
class MessageExtractorTest extends TestCase
{
    ...
    public function dataForTestExtractWithInvalidClassName()
    {
        return [
            ...
            [
                [
                    'class' => 'Fei\Service\Connect\Common\ProfileAssociation\Cryptography\Cryptography',
                    'body' => []
                ],
                new \RuntimeException(
                    'Class must implement Fei\Service\Connect\Common\ProfileAssociation\Message\MessageInterface'
                )
            ]
        ];
    }
